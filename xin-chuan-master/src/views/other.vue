  ...
  <div>
    ...
    <!-- <div>
      ...
      <div>
        <div class="bg">
          <span>微信 ></span>
          <a href="https://www.pdsu.edu.cn/#"> <img src="../assets/images/gongZhongHao.jpg" alt="" /> </a>
        </div>
      </div>
      <div>
        <div class="bg bg2">
          <span>微博 ></span>
          <a href="https://www.pdsu.edu.cn/#"> <img src="../assets/images/weiBo.jpg" alt="" /> </a>
        </div>
      </div>
    </div> -->
  </div>
...
.bg {
  ...
  background: url('../assets/images/wxbg.png') no-repeat 20px 50px;
  width: 90%;
  color: white;
}
.bg2 {
  background: url('../assets/images/wbbg.png') no-repeat 20px 50px;
}
.bg,
.bg2 {
  position: relative;
