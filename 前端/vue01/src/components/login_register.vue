<template>
    <div>
      ...
      <el-link type="primary" @click="isLogin = false, change_rtitle" v-show="isLogin">没有账号？立即注册</el-link>
            <el-button type="primary" @click="isLogin=true, change_rtitle" v-show="!isLogin">返回</el-button>
